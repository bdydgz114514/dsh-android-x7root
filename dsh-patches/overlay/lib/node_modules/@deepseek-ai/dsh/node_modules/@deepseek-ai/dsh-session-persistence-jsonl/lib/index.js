...
import { constants as fsConstants, copyFile, link, lstat, mkdir, mkdtemp, open, readFile, readdir, realpath, rename, rm, stat, truncate } from "node:fs/promises";
...
async function publishCurrentExclusive(staged, currentPath, internals) {
	...
	try {
		await linkOrCopyExclusive(staged, currentPath);
	} catch (error) {
